package com.app.PC_S1.integrationtest;
...
import com.app.PC_S1.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("PC_S1", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/PC_S1/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/PC_S1/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM pc_s1.PetService");
    jdbcTemplate.execute("DELETE FROM pc_s1.PetOwner");
    jdbcTemplate.execute("DELETE FROM pc_s1.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM pc_s1.Manager");
    jdbcTemplate.execute("DELETE FROM pc_s1.Document");
    jdbcTemplate.execute("DELETE FROM pc_s1.Pet");
     jdbcTemplate.execute("DELETE FROM pc_s1.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM pc_s1.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM pc_s1.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM pc_s1.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM pc_s1.PetCareCenterPets");
