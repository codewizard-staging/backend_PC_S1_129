...
import com.app.PC_S1.converter.DurationConverter;
import com.app.PC_S1.converter.UUIDToByteConverter;
import com.app.PC_S1.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"pc_s1\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"pc_s1\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"pc_s1\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"pc_s1\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"pc_s1\"")
